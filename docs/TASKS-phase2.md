...
**Phase 2 closed 2026-08-22.** All tasks built, reviewed, and live on erebor; both halves of the exit criterion — "what do you know about X" and "what did we say about X" — verified on real history 2026-08-21. The full §5.4 loop ran organically on its first day: consolidation extracted, the counters measured, the weekly review collected the first human verdicts, and `memory-replay` stands as the regression gate for prompt changes. This file is the frozen record; the live list is `TASKS.md`. DESIGN.md §5 was the spec, §11 the phase contract.
