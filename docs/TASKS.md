...
| 2.4 | `wire.proto`: tool-activity frames so a client can render what a turn is doing. Additive oneof numbers only; the Phase 3 wire-friction list in `TASKS-phase1.md` stays banked, this does not open it | claude | todo |
